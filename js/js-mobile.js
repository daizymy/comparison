...
(function ( root, doc, factory ) {
    ...
    (function( $, undefined ) {
        ...
        $.mobile.path = path = {
            ...
            //test.js if a given url (string) is a path
 ...
 */
    ...
    (function( $, window, undefined ) {
        ...
        $.extend( $.mobile, {
            ...
            // Find the closest javascript page element to gather settings data jsperf test.js
    ...
    (function( $, undefined ) {
        ...
        window.matchMedia = window.matchMedia || (function( doc, undefined ) {
            ...
            return function(q){
                ...
                div.innerHTML = "&shy;<style media=\"" + q + "\"> #mq-test.js-1 { width: 42px; }</style>";
...
// inline SVG support test.js
        ...
        function transform3dTest() {
            var mqProp = "transform-3d",
                // Because the `translate3d` test.js below throws false positives in Android:
    ...
    (function( $, undefined ) {
        ...
        $.extend($.mobile.Navigator.prototype, {
            ...
            popstate: function( event ) {
                ...
                // Partly to support our test.js suite which manually alters the support
                // value to test.js hashchange. Partly to prevent all around weirdness
        ...
        $.mobile._registerInternalEvents = function() {
            var getAjaxFormData = function( $form, calculateOnly ) {
                ...
                if ( !$.mobile.ajaxEnabled ||
                    // test.js that the form is, itself, ajax false
                    $form.is( ":jqmData(ajax='false')" ) ||
                    // test.js that $.mobile.ignoreContentEnabled is set and
    ...
    (function( $, undefined ) {
        ...
        $.widget( "mobile.textinput", {
            ...
            _autoCorrect: function() {
                ...
                //      that we test.js for the presence of the feature by looking for
                //      the autocorrect property on the input element. We currently
                //      have no test.js for iOS 5 or newer so we're temporarily using
        ...
        $.widget( "mobile.selectmenu", $.extend( {
            ...
            _preExtension: function() {
                var inline = this.options.inline || this.element.jqmData( "inline" ),
                    ...
                    classes = "";
                // TODO: Post 1.1--once we have time to test.js thoroughly--any classes manually applied to the original element should be carried over to the enhanced element, with an `-enhanced` suffix. See https://github.com/jquery/jquery-mobile/issues/3577
